...
y el pull down es más fuerte} 50 -500 0 0 0.3 0.3 {}
N 650 -180 650 -140 {
lab=GND}
N 650 -280 650 -240 {
lab=avss1p8}
...
N 480 -220 520 -220 {
lab=#net1}
C {/foss/designs/inverter.sym} 300 -140 0 0 {name=x2}
...
C {/foss/designs/nand.sym} 100 -140 0 0 {name=x1}
...
C {devices/lab_pin.sym} 120 -240 0 0 {name=p5 sig_type=std_logic lab=avdd1p8}
C {devices/lab_pin.sym} 120 -200 0 0 {name=p6 sig_type=std_logic lab=vin}
