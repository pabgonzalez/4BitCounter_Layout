...
C {devices/lab_pin.sym} 220 -420 2 0 {name=p13 sig_type=std_logic lab=n_clk}
C {devices/lab_pin.sym} 220 -520 2 0 {name=p14 sig_type=std_logic lab=p_clk
}
C {devices/iopin.sym} 100 -480 0 1 {name=p15 lab=D}
C {/foss/designs/tg.sym} 710 -120 0 1 {name=x5
lab=n_clk}
C {devices/lab_pin.sym} 480 -220 2 1 {name=p16 sig_type=std_logic lab=p_clk}
C {devices/lab_pin.sym} 480 -320 2 1 {name=p17 sig_type=std_logic lab=n_clk
}
C {/foss/designs/tg.sym} 700 -320 0 0 {name=x6
lab=p_clk}
C {devices/lab_pin.sym} 930 -420 2 0 {name=p18 sig_type=std_logic lab=p_clk}
C {devices/lab_pin.sym} 930 -520 2 0 {name=p19 sig_type=std_logic lab=n_clk
}
...
C {devices/lab_pin.sym} 1190 -200 2 1 {name=p20 sig_type=std_logic lab=n_clk}
C {devices/lab_pin.sym} 1190 -300 2 1 {name=p21 sig_type=std_logic lab=p_clk
}
