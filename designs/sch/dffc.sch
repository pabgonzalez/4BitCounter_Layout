...
N 390 -640 400 -640 {
lab=p_clk}
C {/foss/designs/sch/inverter.sym} 20 -560 0 0 {name=x1}
C {/foss/designs/sch/inverter.sym} 470 -400 0 0 {name=x2}
C {/foss/designs/sch/inverter.sym} 1420 -480 3 1 {name=x3}
C {/foss/designs/sch/tg.sym} -10 -320 0 0 {name=x4}
C {/foss/designs/sch/nor.sym} 1090 -420 0 0 {name=x8}
C {/foss/designs/sch/nor.sym} 770 -200 0 1 {name=x9}
...
C {/foss/designs/sch/tg.sym} 710 -120 0 1 {name=x5
lab=n_clk}
...
C {/foss/designs/sch/tg.sym} 700 -320 0 0 {name=x6
lab=p_clk}
...
C {/foss/designs/sch/tg.sym} 1420 -100 0 1 {name=x7}
...
C {/foss/designs/sch/inverter.sym} 210 -560 0 0 {name=x10}
